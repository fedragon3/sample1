 ...
 * short:true 문항(하위척도별 1문항, 총 28문항)만으로 "간단 테스트"를 구성합니다.
...
// facet별 5문항. 각 facet 첫 문항은 short:true(간단 테스트 포함).
const QUESTIONS = [
  // ===== NS 자극추구 =====
  { f: "NS1", t: "처음 가보는 장소나 새로운 활동을 발견하면 가슴이 설렌다.", reverse: false, short: true },
  { f: "NS1", t: "새로운 것을 배우거나 시도하는 데서 큰 즐거움을 느낀다.", reverse: false },
  { f: "NS1", t: "호기심이 생기면 직접 경험해봐야 직성이 풀린다.", reverse: false },
  { f: "NS1", t: "늘 하던 방식대로 하는 편이 마음이 편하다.", reverse: true },
  { f: "NS1", t: "새로운 것에 굳이 관심을 두지 않는 편이다.", reverse: true },

  { f: "NS2", t: "마음이 끌리면 깊이 따지지 않고 바로 결정한다.", reverse: false, short: true },
  { f: "NS2", t: "순간적인 기분에 따라 행동할 때가 많다.", reverse: false },
  { f: "NS2", t: "하고 싶은 일이 생기면 참기보다 바로 실행하는 편이다.", reverse: false },
  { f: "NS2", t: "결정을 내리기 전에 충분히 시간을 두고 따져본다.", reverse: true },
  { f: "NS2", t: "감정보다 이성으로 판단하려고 노력한다.", reverse: true },

  { f: "NS3", t: "갖고 싶은 것이 생기면 돈이나 시간을 아끼지 않고 쓴다.", reverse: false, short: true },
  { f: "NS3", t: "좋아하는 일에는 에너지를 아낌없이 쏟는다.", reverse: false },
  { f: "NS3", t: "한번 빠지면 정도를 넘어설 만큼 몰두하곤 한다.", reverse: false },
  { f: "NS3", t: "무엇이든 적당한 선에서 절제하려 한다.", reverse: true },
  { f: "NS3", t: "예산이나 계획을 세워 아껴 쓰는 편이다.", reverse: true },

  { f: "NS4", t: "정해진 규칙이나 틀에 얽매이는 것이 답답하다.", reverse: false, short: true },
  { f: "NS4", t: "형식과 절차보다 내 방식대로 하는 것을 선호한다.", reverse: false },
  { f: "NS4", t: "누군가 지시하거나 통제하려 들면 반발심이 생긴다.", reverse: false },
  { f: "NS4", t: "질서와 규칙을 지키는 것이 중요하다고 생각한다.", reverse: true },
  { f: "NS4", t: "체계적이고 정돈된 환경에서 일이 더 잘된다.", reverse: true },

  // ===== HA 위험회피 =====
  { f: "HA1", t: "앞으로 일어날 일을 미리 걱정하며 마음 졸일 때가 많다.", reverse: false, short: true },
  { f: "HA1", t: "나쁜 결과가 떠올라 쉽게 마음을 놓지 못한다.", reverse: false },
  { f: "HA1", t: "사소한 일에도 최악의 상황을 상상하곤 한다.", reverse: false },
  { f: "HA1", t: "웬만한 일은 잘 될 거라고 낙관하는 편이다.", reverse: true },
  ...
  { f: "HA2", t: "확실하지 않은 선택 앞에서는 쉽게 결정을 못 내린다.", reverse: false },
  { f: "HA2", t: "상황이 불확실해도 크게 개의치 않는다.", reverse: true },
  { f: "HA2", t: "예상 밖의 변화도 흥미롭게 받아들인다.", reverse: true },

  { f: "HA3", t: "낯선 사람들과 있으면 긴장되고 말수가 줄어든다.", reverse: false, short: true },
  { f: "HA3", t: "처음 보는 사람에게 먼저 다가가기가 어렵다.", reverse: false },
  { f: "HA3", t: "여러 사람 앞에 나서는 상황이 부담스럽다.", reverse: false },
  { f: "HA3", t: "누구와도 금방 편하게 어울리는 편이다.", reverse: true },
  { f: "HA3", t: "낯선 자리에서도 자연스럽게 대화를 이끈다.", reverse: true },

  { f: "HA4", t: "조금만 무리해도 금방 지치고 기운이 빠진다.", reverse: false, short: true },
  { f: "HA4", t: "스트레스를 받으면 회복하는 데 오래 걸린다.", reverse: false },
  { f: "HA4", t: "일이 몰리면 쉽게 소진되는 느낌이 든다.", reverse: false },
  { f: "HA4", t: "웬만한 일에는 지치지 않고 활력이 넘친다.", reverse: true },
  ...
  { f: "RD1", t: "슬픈 소식을 들으면 오래도록 마음이 쓰인다.", reverse: false },
  { f: "RD1", t: "감정에 휘둘리지 않고 담담한 편이다.", reverse: true },
  { f: "RD1", t: "웬만한 일에는 크게 감정이 동요하지 않는다.", reverse: true },

  { f: "RD2", t: "따뜻한 정을 나누는 관계를 소중히 여긴다.", reverse: false, short: true },
  { f: "RD2", t: "사람들과 마음을 터놓고 지내는 것이 좋다.", reverse: false },
  { f: "RD2", t: "친밀한 사이에서는 애정 표현을 아끼지 않는다.", reverse: false },
  { f: "RD2", t: "사람들과 일정한 거리를 두는 편이 편하다.", reverse: true },
  { f: "RD2", t: "속마음을 잘 드러내지 않는 편이다.", reverse: true },

  { f: "RD3", t: "가까운 사람과 오래 떨어져 있으면 몹시 그립다.", reverse: false, short: true },
  { f: "RD3", t: "소중한 사람과의 유대가 내 삶에서 매우 중요하다.", reverse: false },
  { f: "RD3", t: "헤어짐이나 이별에 마음이 크게 흔들린다.", reverse: false },
  { f: "RD3", t: "혼자 있어도 외로움을 잘 느끼지 않는다.", reverse: true },
  { f: "RD3", t: "관계가 멀어져도 비교적 담담하게 받아들인다.", reverse: true },

  { f: "RD4", t: "다른 사람에게 인정과 칭찬을 받으면 큰 힘이 난다.", reverse: false, short: true },
  { f: "RD4", t: "주변의 좋은 평가가 내 행동에 영향을 준다.", reverse: false },
  { f: "RD4", t: "누군가 나를 알아봐 주기를 바라는 마음이 있다.", reverse: false },
  { f: "RD4", t: "남의 평가와 상관없이 내 기준대로 행동한다.", reverse: true },
  { f: "RD4", t: "인정받지 못해도 크게 개의치 않는다.", reverse: true },

  // ===== PS 인내력 =====
  { f: "PS1", t: "해야 할 일이 있으면 미루지 않고 부지런히 한다.", reverse: false, short: true },
  { f: "PS1", t: "힘든 일도 기꺼이 노력을 들여 해낸다.", reverse: false },
  { f: "PS1", t: "성실하게 꾸준히 하는 것에서 보람을 느낀다.", reverse: false },
  { f: "PS1", t: "하기 싫은 일은 자꾸 미루게 된다.", reverse: true },
  { f: "PS1", t: "가능하면 편하게 할 수 있는 방법부터 찾는다.", reverse: true },

  { f: "PS2", t: "한번 시작한 일은 어려워도 끝까지 해낸다.", reverse: false, short: true },
  { f: "PS2", t: "장애물이 생겨도 포기하지 않고 계속 밀고 나간다.", reverse: false },
  { f: "PS2", t: "실패해도 다시 도전하는 편이다.", reverse: false },
  { f: "PS2", t: "잘 안 풀리면 금방 흥미를 잃고 그만둔다.", reverse: true },
  { f: "PS2", t: "벽에 부딪히면 다른 쉬운 길을 찾는다.", reverse: true },

  { f: "PS3", t: "남보다 더 나은 성과를 내고 싶은 욕심이 있다.", reverse: false, short: true },
  { f: "PS3", t: "높은 목표를 세우고 그것을 이루려 애쓴다.", reverse: false },
  { f: "PS3", t: "인정받는 성취를 위해 기꺼이 더 노력한다.", reverse: false },
  { f: "PS3", t: "적당한 수준에서 만족하는 편이다.", reverse: true },
  { f: "PS3", t: "굳이 남들과 경쟁하고 싶지 않다.", reverse: true },

  { f: "PS4", t: "맡은 일은 흠 없이 완벽하게 마무리하고 싶다.", reverse: false, short: true },
  { f: "PS4", t: "작은 실수도 그냥 넘기지 못하고 다시 손본다.", reverse: false },
  { f: "PS4", t: "기준에 못 미치는 결과는 좀처럼 만족스럽지 않다.", reverse: false },
  { f: "PS4", t: "완벽하지 않아도 충분히 괜찮다고 여긴다.", reverse: true },
  { f: "PS4", t: "세세한 것보다 전체적으로 되면 만족한다.", reverse: true },

  // ===== SD 자율성 =====
  { f: "SD1", t: "내 선택의 결과는 내가 책임진다고 생각한다.", reverse: false, short: true },
  { f: "SD1", t: "문제가 생기면 남 탓보다 내가 할 일을 먼저 찾는다.", reverse: false },
  { f: "SD1", t: "맡은 역할에 대한 책임을 끝까지 진다.", reverse: false },
  ...
  { f: "SD2", t: "장기적인 목표에 맞춰 지금의 행동을 조율한다.", reverse: false },
  { f: "SD2", t: "내가 무엇을 원하는지 잘 모를 때가 많다.", reverse: true },
  { f: "SD2", t: "뚜렷한 목표 없이 그때그때 살아간다.", reverse: true },

  { f: "SD3", t: "어려운 문제도 스스로 해결할 수 있다고 믿는다.", reverse: false, short: true },
  ...
  { f: "SD3", t: "중요한 일 앞에서 자신감이 부족하다.", reverse: true },

  { f: "SD4", t: "나는 지금의 나 자신을 있는 그대로 받아들인다.", reverse: false, short: true },
  { f: "SD4", t: "내 장점과 단점을 모두 인정하며 편안하다.", reverse: false },
  { f: "SD4", t: "남과 비교하지 않고 내 모습에 만족한다.", reverse: false },
  { f: "SD4", t: "내 모습이 자주 마음에 들지 않는다.", reverse: true },
  { f: "SD4", t: "다른 사람처럼 되지 못한 것이 아쉽다.", reverse: true },

  // ===== CO 연대감 =====
  { f: "CO1", t: "나와 다른 생각이나 방식도 존중하려 한다.", reverse: false, short: true },
  { f: "CO1", t: "사람마다 다를 수 있다는 것을 자연스럽게 받아들인다.", reverse: false },
  { f: "CO1", t: "편견 없이 다양한 사람을 대하려 노력한다.", reverse: false },
  { f: "CO1", t: "나와 다른 사람은 이해하기 어렵다.", reverse: true },
  ...
  { f: "CO2", t: "누군가 힘들어하면 그 심정에 깊이 공감한다.", reverse: false },
  { f: "CO2", t: "남의 감정까지 신경 쓰는 것은 피곤하다.", reverse: true },
  { f: "CO2", t: "다른 사람의 사정에는 별로 관심이 가지 않는다.", reverse: true },

  { f: "CO3", t: "도움이 필요한 사람을 보면 기꺼이 나선다.", reverse: false, short: true },
  { f: "CO3", t: "내 손해를 조금 감수하더라도 남을 돕곤 한다.", reverse: false },
  { f: "CO3", t: "다른 사람에게 베푸는 데서 보람을 느낀다.", reverse: false },
  { f: "CO3", t: "내 일이 우선이라 남을 챙길 여유가 없다.", reverse: true },
  { f: "CO3", t: "대가 없이 남을 돕는 것은 손해라고 생각한다.", reverse: true },

  { f: "CO4", t: "잘못한 사람도 사정을 헤아려 용서하려 한다.", reverse: false, short: true },
  { f: "CO4", t: "보복보다 이해와 화해를 택하는 편이다.", reverse: false },
  { f: "CO4", t: "약하거나 어려운 처지의 사람에게 마음이 쓰인다.", reverse: false },
  { f: "CO4", t: "잘못한 사람은 반드시 대가를 치러야 한다고 본다.", reverse: true },
  { f: "CO4", t: "한번 상처받으면 좀처럼 용서하기 어렵다.", reverse: true },

  // ===== ST 자기초월 =====
  { f: "ST1", t: "무언가에 깊이 빠져 시간 가는 줄 모를 때가 있다.", reverse: false, short: true },
  { f: "ST1", t: "몰입할 때는 나 자신을 잊을 만큼 집중한다.", reverse: false },
  { f: "ST1", t: "창작이나 상상에 잠기는 순간이 좋다.", reverse: false },
  { f: "ST1", t: "늘 현실 감각을 놓치지 않으려 한다.", reverse: true },
  { f: "ST1", t: "공상에 잠기기보다 실제 일에 집중한다.", reverse: true },

  { f: "ST2", t: "나는 나 자신이 더 큰 자연·세계의 일부라고 느낀다.", reverse: false, short: true },
  { f: "ST2", t: "모든 존재가 어떤 식으로든 연결되어 있다고 느낀다.", reverse: false },
  { f: "ST2", t: "자연 속에서 나를 넘어선 무언가와 하나 되는 느낌을 받은 적이 있다.", reverse: false },
  { f: "ST2", t: "나는 세상과 분리된 하나의 개인일 뿐이라고 여긴다.", reverse: true },
  { f: "ST2", t: "그런 일체감 같은 것은 잘 와닿지 않는다.", reverse: true },

  { f: "ST3", t: "논리로 설명되지 않는 영적 경험에 열려 있다.", reverse: false, short: true },
  { f: "ST3", t: "과학으로 다 설명할 수 없는 무언가가 있다고 믿는다.", reverse: false },
  { f: "ST3", t: "직관이나 알 수 없는 이끌림을 신뢰할 때가 있다.", reverse: false },
  { f: "ST3", t: "증명되지 않은 것은 잘 믿지 않는다.", reverse: true },
  { f: "ST3", t: "눈에 보이고 검증된 것만 받아들인다.", reverse: true },

  { f: "ST4", t: "눈앞의 이익보다 더 큰 의미와 가치를 좇는다.", reverse: false, short: true },
  { f: "ST4", t: "세상이 더 나아질 수 있다고 믿으며 그것을 바란다.", reverse: false },
  { f: "ST4", t: "물질적 성공보다 삶의 의미가 더 중요하다.", reverse: false },
  { f: "ST4", t: "현실적이고 실용적인 것이 이상보다 우선이다.", reverse: true },
  { f: "ST4", t: "이상은 결국 현실 앞에서 소용없다고 느낀다.", reverse: true },
];
