...
function buildCategories(r) {
  ...
  const TODAY = {
    bigeop: "경쟁과 협력의 기운이 함께 도는 날입니다. 뜻이 맞는 사람과 힘을 합치면 평소보다 큰 시너지가 나고, 내 주관을 뚜렷이 세워 주도적으로 움직일 때 좋은 결과가 따릅니다. 다만 고집이 세지거나 남과 부딪히기 쉬운 날이기도 하니, 이기려는 마음보다 함께 가려는 태도가 이롭습니다. 충동적인 지출이나 즉흥적인 결정은 하루쯤 미뤄 두는 편이 안전합니다.",
    siksang: "표현하고 활동하기 좋은 날입니다. 마음속 아이디어를 밖으로 꺼내거나 그동안 갈고닦은 재능을 펼치기에 알맞고, 새로운 시도가 뜻밖의 즐거움과 인연을 데려옵니다. 말과 글, 콘텐츠처럼 나를 드러내는 일에서 특히 반응이 좋습니다. 에너지가 밖으로 향하는 날이니 혼자 담아 두기보다 사람들과 나누며 흐름을 키워 보세요.",
    jae: "재물과 기회의 기운이 들어오는 날입니다. 거래·구매·정산처럼 손에 잡히는 실무나 현실적인 성과에 유리하고, 미뤄 둔 금전 문제를 매듭짓기에도 좋습니다. 다만 눈앞의 이익에 마음이 급해지면 지나친 욕심이 오히려 화를 부를 수 있으니, 계획한 범위 안에서 움직이세요. 오늘 들어온 기회는 서두르기보다 하루 살펴본 뒤 잡아도 늦지 않습니다.",
    inseong: "도움과 배움의 기운이 감도는 날입니다. 공부하고 정리하고 기대는 일이 잘 풀리며, 윗사람이나 조력자의 손길이 자연스럽게 닿습니다. 혼자 끙끙대던 문제도 조언을 구하면 뜻밖에 쉽게 실마리가 보이니, 오늘만큼은 도움 청하기를 주저하지 마세요. 몸과 마음을 충전하는 휴식도 이 기운과 잘 어울립니다.",
    gwan: "책임과 규율의 기운이 강한 날입니다. 일·시험·마감·공적인 자리에서 성취와 인정이 따르고, 맡은 역할을 성실히 해낼수록 평가가 올라갑니다. 뒤에서 애쓰기보다 드러나게 일하는 것이 이득인 날이에요. 다만 어깨에 실리는 압박과 긴장이 커지기 쉬우니, 완벽을 향한 조급함은 조금 내려놓고 스스로를 다독이며 페이스를 지키세요.",
  };
  const today = {
  ...
  const love = {
    ...
    body: P(`연애운은 ${loveNote} 기운으로 봅니다. 당신의 사주에는 이 기운이 ${loveN}개로, ${verdict(loveN).label}한 편입니다.`) +
      P(loveN >= 2
        ? "인연의 기운이 넉넉해 만남의 기회가 자연스럽게 열리고, 이미 있는 관계라면 한층 깊어지기 좋은 흐름입니다. 매력이 밖으로 잘 드러나는 시기라 먼저 다가가도 좋은 반응을 얻습니다. 다만 마음이 앞서 서두르면 상대가 부담을 느낄 수 있으니, 상대의 속도를 존중하며 천천히 쌓아 갈 때 관계가 오래갑니다."
        : loveN === 1
          ? "인연의 기운은 무난합니다. 요란한 이벤트보다 익숙한 모임이나 신뢰가 쌓인 자리에서 마음이 조용히 오가는 시기예요. 가까운 사람을 새롭게 다시 보게 되거나, 소개·모임을 통해 좋은 만남이 찾아오기 쉽습니다. 조건을 먼저 따지기보다 편안함과 대화의 결을 살피면 인연이 한결 선명해집니다."
          : "인연의 기운이 은은한 편이라, 지금은 사람을 좇기보다 나를 가꾸고 활동 반경을 넓히는 데 힘쓸 때입니다. 관심사를 넓히고 새로운 자리에 나가다 보면 그 과정에서 자연스럽게 좋은 사람이 곁에 다가옵니다. 조급함은 오히려 인연을 밀어내니, 스스로를 채우는 시간을 즐기세요.") +
      P(`연애 스타일: ${ELEM_TRAIT[D].love}입니다. 이 결을 이해하고 살리면 나에게 잘 맞는 관계의 방식을 찾는 데 도움이 됩니다.`),
  };
  ...
  const work = {
    ...
    body: P(`직장·명예운은 조직과 규율을 뜻하는 <b>관성</b>으로 봅니다. 사주에 관성이 ${tg.gwan}개로 ${verdict(tg.gwan).label}합니다.`) +
      P(tg.gwan >= 2
        ? "조직 안에서 책임과 직책을 맡아 인정받는 흐름입니다. 규율 있는 환경일수록 강점이 살아나고, 맡은 일을 성실히 해내면 승진·평가·중요한 자리 배정에서 유리한 고지를 차지합니다. 지금은 뒤에서 애쓰기보다 드러나게 일하며 성과를 보여 줄 때 이득이 큽니다."
        : tg.gwan === 1
          ? "무난한 직장운으로, 눈에 띄는 도약보다 성실함이 차곡차곡 신뢰로 쌓이는 시기입니다. 당장의 인정이 더디더라도 꾸준함이 결국 기회를 부르니 조급해하지 마세요. 맡은 자리에서 실력을 다져 두면 흐름이 바뀔 때 크게 도약할 발판이 됩니다."
          : "조직의 틀에 갇히기보다 전문성과 자율성으로 승부할 때 빛나는 유형입니다. 정해진 규율보다 스스로 판을 짜는 환경에서 능력이 살아나므로, 전문직·프리랜서·창업처럼 자기 색을 낼 수 있는 길이 잘 어울립니다. 내 강점을 보여줄 프로젝트에 먼저 손을 들어 보세요.") +
      P(`적성: ${nm(strong)} 기운이 강해 ${ELEM_TRAIT[strong].field} 분야가 잘 맞습니다. 진로나 업무 방향을 고민할 때 이 결을 참고하면 시행착오를 줄일 수 있습니다.`),
  };
  ...
  const money = {
    ...
    body: P(`재물운은 재화를 뜻하는 <b>재성</b>으로 봅니다. 사주에 재성이 ${tg.jae}개로 ${verdict(tg.jae).label}합니다.`) +
      P(tg.jae >= 2
        ? "재물을 다루고 불리는 감각이 좋아 현실적인 기회를 놓치지 않고 살립니다. 거래·투자·협상처럼 돈이 오가는 일에서 손에 잡히는 성과가 따르기 쉬운 시기예요. 다만 감각을 믿고 크게 벌이기보다 큰 욕심을 다스리고 꾸준히 관리할 때 그 부가 오래 지켜집니다. 새는 돈을 막는 습관도 버는 것만큼 중요합니다."
        : tg.jae === 1
          ? "재물운은 무난합니다. 한 번의 횡재보다 성실한 노력이 착실한 축적으로 이어지는 흐름이에요. 수입과 지출을 규모 있게 관리하며 기반을 다지면, 시간이 쌓일수록 안정된 재물의 토대가 만들어집니다. 무리한 확장보다 지킴과 절약이 이로운 시기입니다."
          : "재물이 들어오는 길이 다소 좁을 수 있으니, 재능·활동(식상)으로 재성을 키우는 전략이 유효합니다. 잘하는 일을 수입으로 연결하고 나를 알리는 통로를 넓힐수록 돈이 붙는 길도 함께 넓어집니다. 지금은 목돈을 노리기보다 실력을 자산으로 바꾸는 데 집중할 때입니다.") +
      (tg.siksang >= 2 ? P("특히 표현·활동의 재능이 재물로 이어지는 구조라, 콘텐츠·기술·영업처럼 능력을 밖으로 드러내는 일에서 기회가 큽니다. 내 재능이 곧 재산이 되는 흐름이니 이를 적극 활용해 보세요.") : ""),
  };
  ...
  const health = {
    ...
    body: P(`건강은 사주에서 약한 오행으로 살핍니다. ${nm(hTarget)} 기운이 ${missing.length ? "없어" : "약해"} ${ELEM_TRAIT[hTarget].organ} 계통을 평소 살피면 좋습니다. 특정 질환을 뜻한다기보다, 피로가 쌓일 때 가장 먼저 신호가 오는 부위라고 이해하면 됩니다.`) +
      P(`충분한 휴식과 규칙적인 생활이 최고의 보약입니다. 무리해서 몸을 몰아붙이기보다 잘 자고 잘 먹는 기본을 지키는 것이 이 기운을 보완하는 가장 확실한 방법이에요. ${nm(hTarget)}을 상징하는 ${ELEM_LUCK[hTarget].color} 계열의 색과 ${ELEM_LUCK[hTarget].dir} 방위의 기운을 가까이하면 몸의 균형을 잡는 데 도움이 됩니다.`) +
  ...
  const sewoon = {
    ...
    body: P(`올해는 <b>${STEMS[seStem]}${BRANCHES[seBranch]}(${STEMS_H[seStem]}${BRANCHES_H[seBranch]})</b>년, ${ANIMALS[seBranch]}띠 해입니다. 당신의 일간(${STEMS[r.dayMaster]}) 기준으로 <b>${TEN_GOD_KO[seRel]}</b>의 기운이 들어옵니다.`) +
      ...
      P(`이 기운은 한 해 전체를 관통하는 큰 배경과 같아서, 매일의 작은 선택보다 올해 어디에 힘을 싣고 무엇을 대비할지를 가늠하는 데 쓰면 좋습니다. 흐름을 미리 알고 강점은 살리고 약한 부분은 준비해 두면, 같은 일도 한결 수월하게 풀립니다.`),
  };
  ...
  if (!di) {
    ...
    daeun.body = P(`대운은 10년마다 바뀌는 인생의 큰 흐름입니다. 세운(그해의 운)이 날씨라면 대운은 계절에 해당해, 한 사람의 삶의 방향을 10년 단위로 크게 물들입니다. 당신은 <b>${gender} · ${di.forward ? "순행" : "역행"}</b>이며 첫 대운은 <b>약 ${di.startAge}세</b>부터 시작합니다.`) +
      `<div class="daegrid">${cells}</div>` +
      (di.current ? P(`지금(약 ${Math.floor(di.ageNow)}세)은 <b>${TEN_GOD_KO[di.current.tenGod]}</b> 대운의 흐름 속에 있습니다. ${TEN_GOD_THEME[di.current.tenGod]} 이 시기의 결을 이해하고 그에 맞춰 방향을 잡으면 10년을 한결 알차게 보낼 수 있습니다.`) : "") +
  ...
  const overall = {
    ...
    body: [rd.sections[0], rd.sections[1], rd.sections[5]].map((s) =>
      ...
      P(`이 세 가지를 종합하면, 타고난 기질을 억누르기보다 그 결을 이해하고 살릴 때 삶이 가장 자연스럽게 풀립니다. 부족한 오행은 채우고 강한 기운은 방향을 잡아 주면, 사주는 정해진 운명이 아니라 나를 더 잘 이해하고 쓰는 지도가 됩니다.`),
  };
